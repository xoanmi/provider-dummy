...
The [provider-dummy](https://github.com/crossplane/provider-dummy) repository can be
...
- [ ]  Code is licensed under the [Apache 2.0
  License](https://github.com/crossplane/provider-dummy/blob/main/LICENSE)
...
- [ ]  Update
  [OWNERS.md](https://github.com/crossplane/provider-dummy/blob/main/OWNERS.md)
...
- [ ]  Ensure `hack/boilerplate.go.txt` (used in Code generation) includes
  ...
  [https://github.com/crossplane/provider-dummy/blob/main/hack/boilerplate.go.txt](https://github.com/crossplane/provider-dummy/blob/main/hack/boilerplate.go.txt)
...
The [provider-dummy](https://github.com/crossplane/provider-dummy)
...
- [ ] Create a [Crossplane
  ...
  configuration (see
  [package/crossplane.yaml)](https://github.com/crossplane/provider-dummy/blob/main/package/crossplane.yaml)
...
- [ ] Utilize GitHub workflows from
  <https://github.com/crossplane/provider-dummy/tree/main/.github/workflows>
...
- [ ] Enable Issues on your project and configure Issue dummys (examples at:
  [.github/ISSUE_TEMPLATE](https://github.com/crossplane/provider-dummy/tree/master/.github/ISSUE_TEMPLATE))
- [ ] Create Pull Request RestApiExamples: (example:
  [PULL_REQUEST_TEMPLATE.md](https://github.com/crossplane/provider-dummy/blob/master/.github/PULL_REQUEST_TEMPLATE.md))
